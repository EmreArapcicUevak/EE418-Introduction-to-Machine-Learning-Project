...
export default function ExploreScreen() {
  ...
  const ListHeaderComponent = () => (
    <>
      ...
      {/* Best Deals Carousel */}
      {bestDeals.length > 0 && !bestDealsLoading && (
      ...
      {bestDealsError && (
        <View style={styles.bestDealsSection}>
          <Text style={styles.bestDealsError}>
            Best deals are temporarily unavailable
          </Text>
        </View>
      )}
    </>
    ...
    if (filters.source !== "olx") {
      chips.push(
        <Chip
          ...
          onClose={() => setFilters({ ...filters, source: "olx" })}
        >
      ...
      <BlurView intensity={95} tint="light" style={styles.topBar}>
        ...
        <View style={styles.topBarContent}>
          <TouchableOpacity
            style={[
              styles.topBarButton,
              activeFilterCount > 0 && styles.topBarButtonActive,
            ]}
            onPress={() => {
          ...
          >
            ...
            <Text
              style={[
                ...
                activeFilterCount > 0 && styles.topBarButtonTextActive,
              ]}
            >
